# Wongnai-corpus
This project is a collection of Wongnai's datasets which are mostly in Thai language. We hope that these datasets can help  researchers to advance [Thai NLP](https://www.facebook.com/groups/thainlp). 
